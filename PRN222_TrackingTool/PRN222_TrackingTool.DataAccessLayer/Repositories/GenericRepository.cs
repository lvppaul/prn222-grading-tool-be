...
namespace PRN222_TrackingTool.DataAccessLayer.Repositories
{
    ...
    {
        protected Prn222TrackingToolContext _context;

        public GenericRepository() => _context ??= new Prn222TrackingToolContext();

        public GenericRepository(Prn222TrackingToolContext context) => _context = context;
